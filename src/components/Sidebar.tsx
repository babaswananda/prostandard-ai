      ...
      <nav className="flex h-full w-full flex-col px-3" aria-label="Chat history">
          ...
          <div className="bg-white pt-0">
            <div className="flex flex-col gap-2 px-2 py-2">
              <div className="group flex h-10 items-center gap-2.5 rounded-lg px-2 hover:bg-gray-100 cursor-pointer">
                ...
                <span className="text-sm text-black">ChatGPT</span>
              </div>
              <div className="group flex h-10 items-center gap-2.5 rounded-lg px-2 hover:bg-gray-100 cursor-pointer">
                <div className="h-6 w-6 flex items-center justify-center">
                  <Globe className="h-4 w-4 text-black" />
                </div>
                <span className="text-sm text-black">Explore GPTs</span>
              </div>
            </div>
              ...
              {timeframes.map((timeframe) => (
                <div key={timeframe.title}>
                  ...
                  {timeframe.items.map((item) => (
                    <div key={item} className="group flex h-10 items-center gap-2.5 rounded-lg px-2 hover:bg-gray-100 cursor-pointer">
        ...
        {isOpen && (
          <div className="flex flex-col py-2 border-t border-gray-200">
            <button className="group flex gap-2 p-2.5 text-sm items-start hover:bg-gray-100 rounded-lg px-2 text-left w-full min-w-[200px]">
